            ...
            <tr>
              ...
              <td class="forminp">
                <select name="appad_clpr_active">
                  <option value="no" <?php if(get_option('appad_clpr_active') == 'no'){ echo 'selected="selected"'; } ?> ><?php _e('No', 'appad'); ?></option>
                  <option value="yes" <?php if(get_option('appad_clpr_active') == 'yes'){ echo 'selected="selected"'; } ?> ><?php _e('Yes', 'appad'); ?></option>
                </select>
            ...
            <tr>
              ...
              <td class="forminp">
                <select name="appad_clpr_between_active">
                  <option value="no" <?php if(get_option('appad_clpr_between_active') == 'no'){ echo 'selected="selected"'; } ?> ><?php _e('No', 'appad'); ?></option>
                  <option value="yes" <?php if(get_option('appad_clpr_between_active') == 'yes'){ echo 'selected="selected"'; } ?> ><?php _e('Yes', 'appad'); ?></option>
                </select>
            ...
            <tr>
              ...
              <td class="forminp">
                <select name="appad_clpr_between_frequency">
                  <?php for($i = 1; $i <= 10; $i++): ?>
                  <option value="<?php echo $i; ?>" <?php if(get_option('appad_clpr_between_frequency') == $i){ echo 'selected="selected"'; } ?> ><?php echo $i; ?></option>
                  <?php endfor; ?>
                </select>
