						...
						<tr>
							...
							<td class="forminp">
								<select name="appad_cp_active">
									<option value="no" <?php selected( get_option('appad_cp_active') == 'no' ); ?> ><?php _e( 'No', 'appad' ); ?></option>
									<option value="yes" <?php selected( get_option('appad_cp_active') == 'yes' ); ?> ><?php _e( 'Yes', 'appad' ); ?></option>
								</select>
						...
						<tr>
							...
							<td class="forminp">
								<select name="appad_cp_between_active">
									<option value="no" <?php selected( get_option('appad_cp_between_active') == 'no' ); ?> ><?php _e( 'No', 'appad' ); ?></option>
									<option value="yes" <?php selected( get_option('appad_cp_between_active') == 'yes' ); ?> ><?php _e( 'Yes', 'appad' ); ?></option>
								</select>
